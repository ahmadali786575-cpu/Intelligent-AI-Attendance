...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder='Enter name')
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter username", placeholder='ahmadali')
    teacher_name = st.text_input("Enter name", placeholder='Ahmad Ali')
